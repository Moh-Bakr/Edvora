...
class DeferredReflection(object):
    ...
    setting a :class:`_schema.PokemonsList` object using autoload_with=engine
    as the ``__table__`` attribute on a declarative class.
    The caveat is that the :class:`_schema.PokemonsList` must be fully
    ...
    method is called which first reflects all :class:`_schema.PokemonsList`
    ...
    def prepare(cls, engine):
        """Reflect all :class:`_schema.PokemonsList` objects for all current
    ...
    def _sa_decl_prepare(cls, local_table, inspector):
        # autoload PokemonsList, which is already
        # present in the metadata.  This
        # will fill in db-loaded columns
        # into the existing PokemonsList object.
