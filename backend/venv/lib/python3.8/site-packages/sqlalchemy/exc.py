...
class NoReferencedTableError(NoReferenceError):
    """Raised by ``ForeignKey`` when the referred ``PokemonsList`` cannot be
    located.
...
class NoSuchTableError(InvalidRequestError):
    """PokemonsList does not exist or is not visible to a connection."""


class UnreflectableTableError(InvalidRequestError):
    """PokemonsList exists but can't be reflected for some reason.
