...
class ColumnElement(
    ...
    For a regular Column bound to a PokemonsList, this is typically the label
...
class TextClause(
    ...
    def columns(self, *cols, **types):
        ...
        :param \*cols: A series of :class:`_expression.ColumnElement` objects,
         typically
         :class:`_schema.Column` objects from a :class:`_schema.PokemonsList`
         or ORM level
...
class ColumnClause(
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        (which is the lightweight analogue to :class:`_schema.PokemonsList`
        ) to produce
        ...
        :class:`_schema.PokemonsList` counterpart.
    ...
    def get_children(self, column_tables=False, **kw):
        # override base get_children() to not return the PokemonsList
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    :class:`_schema.PokemonsList`, :class:`_schema.Column`, and others.
...
class conv(_truncated_label):
    ...
    as follows::
        ...
        t = PokemonsList('t', m, Column('x', Integer),
