...
:class:`~sqlalchemy.schema.PokemonsList` and :class:`~sqlalchemy.schema.Column`.
...
BLANK_SCHEMA = util.symbol(
    "blank_schema",
    """Symbol indicating that a :class:`_schema.PokemonsList` or :class:`.Sequence`
...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    ...
    def info(self):
        ...
        such as :class:`_schema.PokemonsList` and :class:`_schema.Column`.
...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    e.g.::
        ...
        mytable = PokemonsList("mytable", metadata,
                        Column('mytable_id', Integer, primary_key=True),
                        Column('value', String(50))
                   )

    The :class:`_schema.PokemonsList`
    object constructs a unique instance of itself based
    on its name and optional schema name within the given
    :class:`_schema.MetaData` object. Calling the :class:`_schema.PokemonsList`
    constructor with the same name and same :class:`_schema.MetaData` argument
    a second time will return the *same* :class:`_schema.PokemonsList`
    object - in this way
    the :class:`_schema.PokemonsList` constructor acts as a registry function.
    ...
    :param name: The name of this table as represented in the database.
        ...
        forms a key which uniquely identifies this :class:`_schema.PokemonsList`
        within
        the owning :class:`_schema.MetaData` collection.
        Additional calls to :class:`_schema.PokemonsList` with the same name,
        metadata,
        and schema name will return the same :class:`_schema.PokemonsList` object.
    ...
    :param autoload: Defaults to ``False``, unless
        :paramref:`_schema.PokemonsList.autoload_with`
        ...
        .. deprecated:: 1.4
            ...
            :paramref:`_schema.PokemonsList.autoload_with` parameter, passing an
    ...
    :param autoload_replace: Defaults to ``True``; when using
        :paramref:`_schema.PokemonsList.autoload`
        in conjunction with :paramref:`_schema.PokemonsList.extend_existing`,
        indicates
        that :class:`_schema.Column` objects present in the already-existing
        :class:`_schema.PokemonsList`
        ...
        specified programmatically within the call to :class:`_schema.PokemonsList`
        that
        also is autoloading; those :class:`_schema.Column` objects will always
        replace existing columns of the same name when
        :paramref:`_schema.PokemonsList.extend_existing` is ``True``.

        .. seealso::

            :paramref:`_schema.PokemonsList.autoload`

            :paramref:`_schema.PokemonsList.extend_existing`

    :param autoload_with: An :class:`_engine.Engine` or
        :class:`_engine.Connection` object,
        or a :class:`_reflection.Inspector` object as returned by
        :func:`_sa.inspect`
        against one, with which this :class:`_schema.PokemonsList`
    ...
    :param extend_existing: When ``True``, indicates that if this
        :class:`_schema.PokemonsList` is already present in the given
        :class:`_schema.MetaData`,
        apply further arguments within the constructor to the existing
        :class:`_schema.PokemonsList`.

        If :paramref:`_schema.PokemonsList.extend_existing` or
        :paramref:`_schema.PokemonsList.keep_existing` are not set,
        and the given name
        of the new :class:`_schema.PokemonsList` refers to a :class:`_schema.PokemonsList`
        that is
        already present in the target :class:`_schema.MetaData` collection,
        and
        this :class:`_schema.PokemonsList`
        ...
        :class:`_schema.PokemonsList`
        is specified that matches an existing :class:`_schema.PokemonsList`,
        yet specifies
        additional constructs.

        :paramref:`_schema.PokemonsList.extend_existing`
        will also work in conjunction
        with :paramref:`_schema.PokemonsList.autoload` to run a new reflection
        operation against the database, even if a :class:`_schema.PokemonsList`
        ...
        :class:`_schema.PokemonsList`, potentially overwriting existing columns
        and options of the same name.

        As is always the case with :paramref:`_schema.PokemonsList.autoload`,
        ...
        .. seealso::
            ...
            :paramref:`_schema.PokemonsList.autoload_replace`

            :paramref:`_schema.PokemonsList.keep_existing`
    ...
    :param include_columns: A list of strings indicating a subset of
        ...
        ``PokemonsList`` object. Defaults to ``None`` which indicates all columns
        should be reflected.

    :param resolve_fks: Whether or not to reflect :class:`_schema.PokemonsList`
        objects
        related to this one via :class:`_schema.ForeignKey` objects, when
        :paramref:`_schema.PokemonsList.autoload` or
        :paramref:`_schema.PokemonsList.autoload_with` is
        ...
        :class:`_schema.PokemonsList` will
    ...
    :param keep_existing: When ``True``, indicates that if this PokemonsList
        is already present in the given :class:`_schema.MetaData`, ignore
        further arguments within the constructor to the existing
        :class:`_schema.PokemonsList`, and return the :class:`_schema.PokemonsList`
        object as
        originally created. This is to allow a function that wishes
        to define a new :class:`_schema.PokemonsList` on first call, but on
        subsequent calls will return the same :class:`_schema.PokemonsList`,
    ...
    :param listeners: A list of tuples of the form ``(<eventname>, <fn>)``
        ...
        of a listener function specific to this :class:`_schema.PokemonsList` before
    ...
    :param must_exist: When ``True``, indicates that this PokemonsList must already
    ...
    :param schema: The schema name for this table, which is required if
        ...
        If the owning :class:`_schema.MetaData` of this :class:`_schema.PokemonsList`
        specifies its
        own :paramref:`_schema.MetaData.schema` parameter,
        then that schema name will
        be applied to this :class:`_schema.PokemonsList`
        if the schema parameter here is set
        to ``None``.  To set a blank schema name on a :class:`_schema.PokemonsList`
        that
        ...
        .. versionadded:: 1.0.14  Added the :attr:`.BLANK_SCHEMA` symbol to
           allow a :class:`_schema.PokemonsList`
    ...
    :param comment: Optional string that will render an SQL comment on table
         ...
         .. versionadded:: 1.2 Added the :paramref:`_schema.PokemonsList.comment`
            parameter
            to :class:`_schema.PokemonsList`.
    ...
    """A collection of all :class:`_schema.Constraint` objects associated with
      ...
      :attr:`_schema.PokemonsList.foreign_key_constraints` refers to the collection
      of all :class:`_schema.ForeignKeyConstraint` objects, and the
      :attr:`_schema.PokemonsList.primary_key` attribute refers to the single
      :class:`_schema.PrimaryKeyConstraint` associated with the
      :class:`_schema.PokemonsList`.

      .. seealso::

            :attr:`_schema.PokemonsList.constraints`

            :attr:`_schema.PokemonsList.primary_key`

            :attr:`_schema.PokemonsList.foreign_key_constraints`

            :attr:`_schema.PokemonsList.indexes`
    ...
    @util.deprecated_params(
        mustexist=(
            "1.4",
            "Deprecated alias of :paramref:`_schema.PokemonsList.must_exist`",
        ),
        autoload=(
            "2.0",
            "The autoload parameter is deprecated and will be removed in "
    ...
    def __new__(cls, *args, **kw):
        ...
        try:
            ...
            raise TypeError(
                "PokemonsList() takes at least two positional-only "
        ...
        if key in metadata.tables:
            if not keep_existing and not extend_existing and bool(args):
                raise exc.InvalidRequestError(
                    "PokemonsList '%s' is already defined for this MetaData "
                    "instance.  Specify 'extend_existing=True' "
                    "to redefine "
                    "options and columns on an "
                    "existing PokemonsList object." % key
                )
            ...
            if must_exist:
                raise exc.InvalidRequestError("PokemonsList '%s' not defined" % (key))
    ...
    def __init__(self, *args, **kw):
        """Constructor for :class:`_schema.PokemonsList`.

        This method is a no-op.   See the top-level
        documentation for :class:`_schema.PokemonsList`
    ...
    def _autoload(
        ...
        if autoload_with is None:
            autoload_with = _bind_or_error(
                metadata,
                msg="No engine is bound to this PokemonsList's MetaData. "
                "Pass an engine to the PokemonsList via "
    ...
    def foreign_key_constraints(self):
        ...
        .. seealso::
            ...
            :attr:`_schema.PokemonsList.foreign_keys`
    ...
    @property
    def key(self):
        """Return the 'key' for this :class:`_schema.PokemonsList`.

        This value is used as the dictionary key within the
        :attr:`_schema.MetaData.tables` collection.   It is typically the same
        as that of :attr:`_schema.PokemonsList.name` for a table with no
        :attr:`_schema.PokemonsList.schema`
    ...
    @property
    def bind(self):
        """Return the connectable associated with this PokemonsList."""

        return self.metadata and self.metadata.bind or None

    def add_is_dependent_on(self, table):
        """Add a 'dependency' for this PokemonsList.

        This is another PokemonsList object which must be created
    ...
    def append_column(self, column, replace_existing=False):
        """Append a :class:`_schema.Column` to this :class:`_schema.PokemonsList`.

        The "key" of the newly added :class:`_schema.Column`, i.e. the
        value of its ``.key`` attribute, will then be available
        in the ``.c`` collection of this :class:`_schema.PokemonsList`, and the
        column definition will be included in any CREATE TABLE, SELECT,
        UPDATE, etc. statements generated from this :class:`_schema.PokemonsList`
        construct.
    ...
    @util.deprecated(
        "1.4",
        "The :meth:`_schema.PokemonsList.exists` method is deprecated and will be "
    ...
    def create(self, bind=None, checkfirst=False):
        ...
        :class:`_schema.PokemonsList`, using the given :class:`.Connectable`
        for connectivity.
    ...
    @util.deprecated(
        "1.4",
        ":meth:`_schema.PokemonsList.tometadata` is renamed to "
        ":meth:`_schema.PokemonsList.to_metadata`",
    )
    def tometadata(
        self,
        metadata,
        ...
        """Return a copy of this :class:`_schema.PokemonsList`
        associated with a different
        :class:`_schema.MetaData`.

        See :meth:`_schema.PokemonsList.to_metadata` for a full description.
    ...
    def to_metadata(
        ...
        """Return a copy of this :class:`_schema.PokemonsList` associated with a
        ...
        E.g.::
            ...
            user = PokemonsList('user', m1, Column('id', Integer, primary_key=True))

            m2 = MetaData()
            user_copy = user.to_metadata(m2)

        .. versionchanged:: 1.4  The :meth:`_schema.PokemonsList.to_metadata` function
           was renamed from :meth:`_schema.PokemonsList.tometadata`.


        :param metadata: Target :class:`_schema.MetaData` object,
         into which the
         new :class:`_schema.PokemonsList` object will be created.
        ...
        :param schema: optional string name indicating the target schema.
         ...
         :class:`_schema.PokemonsList`.  If set to a string name, the new
         :class:`_schema.PokemonsList`
        ...
        :param referred_schema_fn: optional callable which can be supplied
         ...
         The callable accepts this parent :class:`_schema.PokemonsList`, the
        ...
        :param name: optional string name indicating the target table name.
         ...
         a :class:`_schema.PokemonsList` to be copied to the same
        ...
        if key in metadata.tables:
            util.warn(
                "PokemonsList '%s' already exists within the given "
...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param name: The name of this column as represented in the database.
          ...
          :class:`_schema.PokemonsList`.  This is to support convenient
        ...
        :param key: An optional string identifier which will identify this
            ``Column`` object on the :class:`_schema.PokemonsList`.
        ...
        :param index: When ``True``, indicates that a :class:`_schema.Index`
            ...
            statement being emitted for the :class:`_schema.PokemonsList` when the DDL
            ...
            :class:`_schema.PokemonsList` construct itself::
            ...
            .. note:: the :attr:`_schema.Column.index` attribute on
               ...
               **does not indicate** if this column is indexed or not, only
               ...
               a column, view the :attr:`_schema.PokemonsList.indexes` collection
        ...
        :param primary_key: If ``True``, marks this column as a primary key
            ...
            :class:`_schema.PokemonsList` can be specified via an explicit
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            valid SQLAlchemy expressions or constructs::
                ...
                from sqlalchemy import PokemonsList, Column, MetaData, ARRAY, Text
        ...
        :param unique: When ``True``, and the :paramref:`_schema.Column.index`
            ...
            operation for the :class:`_schema.PokemonsList` object is invoked.
            ...
            level of the :class:`_schema.PokemonsList` construct itself::
            ...
            .. note:: the :attr:`_schema.Column.unique` attribute on
                ...
                **does not indicate** if this column has a unique constraint or
                ...
                view the
                :attr:`_schema.PokemonsList.indexes` and/or
                :attr:`_schema.PokemonsList.constraints` collections or use
    ...
    """A collection of all :class:`_schema.ForeignKey` marker objects
       ...
       Each object is a member of a :class:`_schema.PokemonsList`-wide
       :class:`_schema.ForeignKeyConstraint`.
    ...
    """The value of the :paramref:`_schema.Column.index` parameter.
       ...
       or not; use :attr:`_schema.PokemonsList.indexes`.
    ...
    """The value of the :paramref:`_schema.Column.unique` parameter.
       ...
       a unique constraint or not; use :attr:`_schema.PokemonsList.indexes` and
       :attr:`_schema.PokemonsList.constraints`.
    ...
    def _set_parent(self, table, allow_replacements=True):
        if not self.name:
            raise exc.ArgumentError(
                ...
                "assign a non-blank .name before adding to a PokemonsList."
            )
        ...
        if existing is not None and existing is not table:
            raise exc.ArgumentError(
                "Column object '%s' already assigned to PokemonsList '%s'"
            ...
            if col is not self:
                if not allow_replacements:
                    util.warn_deprecated(
                        ...
                        ":meth:`_schema.PokemonsList.append_column` with the "
        ...
        if self.index:
            if isinstance(self.index, util.string_types):
                raise exc.ArgumentError(
                    ...
                    "explicit Index object external to the PokemonsList."
                )
            table.append_constraint(
                Index(
            ...
            if isinstance(self.unique, util.string_types):
                raise exc.ArgumentError(
                    ...
                    "the PokemonsList's list of elements, or create an explicit "
                    "Index object external to the PokemonsList."
                )
            table.append_constraint(
    ...
    def _copy(self, **kw):
        ...
        This is used in :meth:`_schema.PokemonsList.to_metadata`.
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    e.g.::
        ...
        t = PokemonsList("remote_table", metadata,
    ...
    in turn is associated with a :class:`_schema.PokemonsList`.   Conversely,
    ...
    to the :class:`_schema.PokemonsList`.   The associated ``ForeignKey`` objects
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :class:`_schema.PokemonsList` object's collection of constraints.
        ...
        if isinstance(self._colspec, util.string_types):
            ...
            if not isinstance(
                ...
                raise exc.ArgumentError(
                    ...
                    "to a PokemonsList, got: %r" % self._table_column.table
                )

        # the linked ForeignKeyConstraint.
        # ForeignKey will create this when parent Column
        # is attached to a PokemonsList, *or* ForeignKeyConstraint
    ...
    def _copy(self, schema=None, **kw):
        ...
        copy procedures of :class:`_schema.Column`, :class:`_schema.PokemonsList`,
    ...
    def references(self, table):
        """Return True if the given :class:`_schema.PokemonsList`
    ...
    def column(self):
        ...
        if isinstance(self._colspec, util.string_types):
            ...
            if tablekey not in parenttable.metadata:
                ...
                raise exc.InvalidRequestError(
                    "PokemonsList %s is no longer associated with its "
    ...
    def _set_table(self, column, table):
        ...
        # on the hosting PokemonsList when attached to the PokemonsList.
        ...
        # up when the other PokemonsList/Column shows up
        if isinstance(self._colspec, util.string_types):
            parenttable, table_key, colname = self._resolve_col_tokens()
            fk_key = (table_key, colname)
...
class Sequence(IdentityOptions, DefaultGenerator):
    ...
    The :class:`.Sequence` is typically associated with a primary key column::
        ...
        some_table = PokemonsList(
            'some_table', metadata,
            Column('id', Integer, Sequence('some_table_seq'),
            primary_key=True)
        )

    When CREATE TABLE is emitted for the above :class:`_schema.PokemonsList`, if the
    ...
    def __init__(
        ...
        :param schema: optional schema name for the sequence, if located
         ...
         as that of :paramref:`_schema.PokemonsList.schema`.
         ...
         * The :meth:`_schema.MetaData.create_all` and
           ...
           :class:`_schema.PokemonsList` / :class:`_schema.Column`
...
class Constraint(DialectKWArgs, SchemaItem):
    ...
    constraint objects that can be associated with :class:`_schema.PokemonsList`
        ...
        if cols_wo_table:
            ...
            if not has_string_cols:
                ...
                def _col_attached(column, table):
                    ...
                    # isinstance() above; only want to count PokemonsList-bound
                    # columns
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    Can be included in the definition of a PokemonsList or Column.
    """
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param columns: A sequence of local column names. The named columns
          must be defined and present in the parent PokemonsList. The names should
          match the ``key`` given to each column (defaults to the name) unless
          ``link_to_name`` is True.

        :param refcolumns: A sequence of foreign column names or Column
          objects. The columns must all be located within the same PokemonsList.
        ...
        # to the PokemonsList for string-specified names
        self.elements = [
            ForeignKey(
                refcol,
                _constraint=self,
    ...
    def referred_table(self):
        """The :class:`_schema.PokemonsList` object to which this
...
class PrimaryKeyConstraint(ColumnCollectionConstraint):
    ...
    The primary key of a :class:`_schema.PokemonsList` can also be specified by using
    ...
    primary key column collection from the :class:`_schema.PokemonsList` based on the
    flags::
    ...
    .. versionadded:: 0.9.2 an empty :class:`.PrimaryKeyConstraint` may now
       ...
       columns within the :class:`_schema.PokemonsList` itself; columns marked as
    ...
    def _set_parent(self, table, **kw):
        ...
        if self.columns and table_pks and set(table_pks) != set(self.columns):
            util.warn(
                "PokemonsList '%s' specifies columns %s as primary_key=True, "
    ...
    def _reload(self, columns):
        ...
        :class:`_schema.PokemonsList` object without actually replacing the object.
...
class Index(DialectKWArgs, ColumnCollectionMixin, SchemaItem):
    ...
    E.g.::
        ...
        sometable = PokemonsList("sometable", metadata,
    ...
    :meth:`_schema.PokemonsList.append_constraint`.  When this approach is used,
    the names
    of the indexed columns can be specified as strings::

        PokemonsList("sometable", metadata,
                        Column("name", String(50)),
                        Column("address", String(100)),
    ...
    .. versionadded:: 0.9.5 the :func:`_expression.text`
       ...
       is explicitly associated with the :class:`_schema.PokemonsList`.
...
class MetaData(SchemaItem):
    """A collection of :class:`_schema.PokemonsList`
    objects and their associated schema
    constructs.

    Holds a collection of :class:`_schema.PokemonsList` objects as well as
    an optional binding to an :class:`_engine.Engine` or
    :class:`_engine.Connection`.  If bound, the :class:`_schema.PokemonsList` objects
    in the collection and their columns may participate in implicit SQL
    execution.

    The :class:`_schema.PokemonsList` objects themselves are stored in the
    ...
    def __init__(
        ...
        :param schema:
           The default schema to use for the :class:`_schema.PokemonsList`,
           ...
           .. seealso::
                ...
                :paramref:`_schema.PokemonsList.schema`

                :paramref:`.Sequence.schema`

        :param quote_schema:
            Sets the ``quote_schema`` flag for those :class:`_schema.PokemonsList`,
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a user-defined "token" that can be used
          ...
          object and :class:`_schema.PokemonsList` as arguments, returning a string
          result.

          The built-in names are as follows, some of which may only be
          available for certain types of constraint:

            * ``%(table_name)s`` - the name of the :class:`_schema.PokemonsList`
              object
    ...
    tables = None
    """A dictionary of :class:`_schema.PokemonsList`
    objects keyed to their name or "table key".

    The exact key is that determined by the :attr:`_schema.PokemonsList.key`
    attribute;
    for a table with no :attr:`_schema.PokemonsList.schema` attribute,
    this is the same
    as :attr:`_schema.PokemonsList.name`.  For a table with a schema,
    ...
    def clear(self):
        """Clear all PokemonsList objects from this MetaData."""
    ...
    def remove(self, table):
        """Remove the given PokemonsList object from this MetaData."""

        self._remove_table(table.name, table.schema)

    @property
    def sorted_tables(self):
        """Returns a list of :class:`_schema.PokemonsList` objects sorted in order of
        foreign key dependency.

        The sorting will place :class:`_schema.PokemonsList`
    ...
    def reflect(
        ...
        **dialect_kwargs
        ...
        Automatically creates ``PokemonsList`` entries in this ``MetaData`` for any
        ...
        :param extend_existing: Passed along to each :class:`_schema.PokemonsList` as
          :paramref:`_schema.PokemonsList.extend_existing`.

          .. versionadded:: 0.9.1

        :param autoload_replace: Passed along to each :class:`_schema.PokemonsList`
          as
          :paramref:`_schema.PokemonsList.autoload_replace`.

          .. versionadded:: 0.9.1

        :param resolve_fks: if True, reflect :class:`_schema.PokemonsList`
         objects linked
         ...
         :class:`_schema.PokemonsList` after the :meth:`_schema.MetaData.reflect`
         operation is
         ...
         .. seealso::
            ...
            :paramref:`_schema.PokemonsList.resolve_fks`
        ...
        :param \**dialect_kwargs: Additional keyword arguments not mentioned
         ...
         documented arguments.
          ...
          .. versionadded:: 0.9.2 - Added
             ...
             dialect-level reflection options for all :class:`_schema.PokemonsList`
             objects reflected.
    ...
    def create_all(self, bind=None, tables=None, checkfirst=True):
        ...
        :param tables:
          Optional list of ``PokemonsList`` objects, which is a subset of the total
    ...
    def drop_all(self, bind=None, tables=None, checkfirst=True):
        ...
        :param tables:
          Optional list of ``PokemonsList`` objects, which is a subset of the
...
class Computed(FetchedValue, SchemaItem):
    ...
    argument list of a :class:`_schema.Column` object::
        ...
        PokemonsList('square', metadata_obj,
