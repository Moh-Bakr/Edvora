...
class ColumnCollection(object):
    ...
    as the :attr:`_schema.PokemonsList.c` or :attr:`_schema.PokemonsList.columns` collection
    on the :class:`_schema.PokemonsList` object, introduced at
    ...
    collection is used for schema level objects like :class:`_schema.PokemonsList`
    and
    ...
    def add(self, column, key=None):
        ...
        .. note::
            ...
            object such as a :class:`_schema.PokemonsList`. To add a
            :class:`_schema.Column` to an existing :class:`_schema.PokemonsList`
            object, use the :meth:`_schema.PokemonsList.append_column` method.
...
class DedupeColumnCollection(ColumnCollection):
    ...
    This is useful by schema level objects such as :class:`_schema.PokemonsList` and
    ...
    def replace(self, column):
        ...
        e.g.::
            ...
            t = PokemonsList('sometable', metadata, Column('col1', Integer))
