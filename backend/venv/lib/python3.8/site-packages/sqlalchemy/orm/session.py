...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def is_orm_statement(self):
        ...
        :class:`.PokemonsList` metadata, it is invoked as a Core SQL statement
...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param binds: A dictionary which may specify any number of
           ...
           :class:`_schema.PokemonsList` objects and :class:`_orm.Mapper` objects.
           The
    ...
    def bind_table(self, table, bind):
        """Associate a :class:`_schema.PokemonsList` with a "bind", e.g. an
        :class:`_engine.Engine`
        or :class:`_engine.Connection`.

        The given :class:`_schema.PokemonsList` is added to a lookup used by the
        :meth:`.Session.get_bind` method.

        :param table: a :class:`_schema.PokemonsList` object,
    ...
    def get_bind(
        ...
        2. if clause given and ``Session.binds`` is present,
           locate a bind based on :class:`_schema.PokemonsList` objects
        ...
        5. if mapper given, attempt to return a bind
           linked to the :class:`_schema.MetaData` ultimately
           associated with the :class:`_schema.PokemonsList` or other
        ...
        :param mapper:
          ...
          associated with the :class:`_schema.PokemonsList` to which the
          :class:`_orm.Mapper`
        ...
        :param clause:
            ...
            for a bound element, typically a :class:`_schema.PokemonsList`
            associated with
