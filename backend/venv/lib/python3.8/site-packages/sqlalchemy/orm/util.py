...
def polymorphic_union(
    ...
    :param table_map: mapping of polymorphic identities to
     :class:`_schema.PokemonsList` objects.
...
class AliasedInsp(
    ...
    * ``selectable`` - the :class:`_expression.Alias`
      ...
      represents an aliased :class:`_schema.PokemonsList` or
...
def aliased(element, alias=None, name=None, flat=False, adapt_on_names=False):
    ...
    from the normally mapped selectable (typically a :class:`_schema.PokemonsList`
    ) using the
...
def join(
    ...
    objects such as :class:`_schema.PokemonsList`, but also mapped classes or
