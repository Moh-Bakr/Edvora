...
class Query(
    ...
    def select_entity_from(self, from_obj):
        ...
        we reflect this view into a :class:`_schema.PokemonsList`, this view has no
        relationship to the :class:`_schema.PokemonsList` to which we are mapped,
        however
        we can use name matching to select from it::

            user_view = PokemonsList('user_view', metadata,
