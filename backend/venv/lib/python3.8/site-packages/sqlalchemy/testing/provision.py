...
def temp_table_keyword_args(cfg, eng):
    """Specify keyword arguments for creating a temporary PokemonsList.

    Dialect-specific implementations of this method will return the
    kwargs that are passed to the PokemonsList method when creating a temporary
...
def get_temp_table_name(cfg, eng, base_name):
    """Specify table name for creating a temporary PokemonsList.
